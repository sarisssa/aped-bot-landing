export default function PrivatePolicyScreen() {
  return (
    <div className="mb-20 px-4" style={{ marginTop: "5rem" }}>
      {" "}
      <h1 className="font-bold mb-3">APED BOT PRIVATE POLICY</h1>
      <h3 className="mb-3">Last updated: September 14th, 2023.</h3>
      <h3 className="mb-3">
        By using ApedBot, you agree to be bound by the following Privacy Policy:
      </h3>
      ...
      <ul className="uppercase mb-5">
        ...
        <li className="mb-5 text-xl">
          ...
          damages arising from trades executed through the bot.
        </li>
      </ul>
      <h1 className="font-bold mb-3">APED BOT COOKIE POLICY</h1>
      <h3 className="uppercase mb-3">Last updated: September 14th, 2023.</h3>
      <h3 className=" uppercase mb-3">
        By using ApedBot, you agree to be bound by the following Cookie Policy:
      </h3>
      ...
      <ul className="uppercase mb-5">
        <li className="mb-5 text-xl">
          ...
          are still looking for more information then you can contact us via:
          Email: gm@aped.trade
        </li>
      </ul>
    </div>
